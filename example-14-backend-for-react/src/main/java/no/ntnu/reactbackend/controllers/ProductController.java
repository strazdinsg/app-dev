...
public class ProductController {
     ...
     * @throws InterruptedException An exception if the executing thread is interrupted while it is sleeping
     */
    @GetMapping
    public Collection<Product> getAll() throws InterruptedException {
